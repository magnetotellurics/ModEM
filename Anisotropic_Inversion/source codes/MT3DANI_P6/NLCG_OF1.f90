...
!			nSites,sites,allData)
   ...
   F = SS/Ndata + (lambda * mNorm/Nmodel) + aniNorm/Nmodel

   ! scale mNorm for output
   mNorm = mNorm/Nmodel
   aniNorm = aniNorm/Nmodel
   write(1212,*) lambda * mNorm,aniNorm
...
!**********************************************************************
   ...
   call linComb(ONE,grad,TWO/Nmodel,CmJTd,grad)
...
!**********************************************************************
   ...
   SS = F - (lambda * mNorm/Nmodel) - aniNorm/Nmodel
   ...
   call linComb(ONE,dSS,MinusTWO/Nmodel,m,dSS)
