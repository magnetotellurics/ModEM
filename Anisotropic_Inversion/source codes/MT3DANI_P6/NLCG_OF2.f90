...
!			nSites,sites,allData)
   ...
   F = SS/Ndata + (lambda * mNorm/Nmodel) + lambda * aniNorm/Nmodel

   ! scale mNorm for output
   mNorm = mNorm/Nmodel
   aniNorm = aniNorm/Nmodel
   write(1212,*) lambda * mNorm,lambda * aniNorm
...
!**********************************************************************
   ...
   call linComb(ONE,grad,TWO*lambda/Nmodel,CmJTd,grad)
...
!**********************************************************************
   ...
   SS = F - (lambda * mNorm/Nmodel) - lambda * aniNorm/Nmodel
   ...
   call linComb(ONE,dSS,MinusTWO*lambda/Nmodel,m,dSS)
   ...
   F = SS + (lambda * mNorm/Nmodel) + lambda * aniNorm/Nmodel/iterControl%p

	 ! add the model norm derivative to the gradient of the penalty functional
   call linComb(ONE,dSS,TWO*lambda/Nmodel,mHat,grad)
   call linComb(ONE,grad,TWO*lambda/Nmodel/iterControl%p,m,grad)
