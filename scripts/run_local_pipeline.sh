...
TIME_START=$(date +%s%3N)
bash scripts/test_read_write.sh bin/Mod3DMT_STD $NCORES | tee -a outputs/temp/test_read_write/std_out.txt
TIME_END=$(date +%s%3N)
...
TIME_START=$(date +%s%3N)
bash scripts/test_read_write.sh bin/Mod3DMT_SP2 $NCORES | tee -a outputs/temp/test_read_write/std_out.txt
TIME_END=$(date +%s%3N)
...
TIME_START=$(date +%s%3N)
bash scripts/test_forward.sh bin/Mod3DMT_STD $NCORES | tee -a outputs/temp/test_forward/std_out.txt
TIME_END=$(date +%s%3N)
...
TIME_START=$(date +%s%3N)
bash scripts/test_forward.sh bin/Mod3DMT_SP2 $NCORES | tee -a outputs/temp/test_forward/std_out.txt
TIME_END=$(date +%s%3N)
...
TIME_START=$(date +%s%3N)
bash scripts/test_mult_by_j_t.sh bin/Mod3DMT_STD $NCORES | tee -a outputs/temp/test_mult_by_j_t/std_out.txt
#
RESULT_MULT_STD=$?
#
TIME_END=$(date +%s%3N)
...
TIME_START=$(date +%s%3N)
bash scripts/test_mult_by_j_t.sh bin/Mod3DMT_SP2 $NCORES | tee -a outputs/temp/test_mult_by_j_t/std_out.txt
#
RESULT_MULT_SP2=$?
#
TIME_END=$(date +%s%3N)
...
#
	...
	TIME_START=$(date +%s%3N)
	bash scripts/test_symmetry.sh bin/Mod3DMT_STD $NCORES | tee -a outputs/temp/test_symmetry/std_out.txt
	TIME_END=$(date +%s%3N)
...
#
	...
	TIME_START=$(date +%s%3N)
	bash scripts/test_symmetry.sh bin/Mod3DMT_SP2 $NCORES | tee -a outputs/temp/test_symmetry/std_out.txt
	TIME_END=$(date +%s%3N)
