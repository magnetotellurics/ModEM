...
#
mpirun -np 2 ./ModEM_MPI -f -m ../docs/vti_results/model_VTI_h10_v10.mod -d ../docs/vti_results/Data_Z_1tx_1rx.dat -pd pred_mt_vti_oo.dat -es esol_mt_vti_oo.bin -cf ../docs/vti_results/oo_fwd_control_em1d
#
if [ "$RESULT" -ne "0" ]; then
    #
...
#
mpirun -np 2 ./ModEM_MPI -f -m ../docs/vti_results/model_VTI_h10_v10.mod -d ../docs/vti_results/Data_Ey_1tx_1rx.dat -pd pred_em1d_vti_oo.dat -es esol_em1d_vti_oo.bin -cf ../docs/vti_results/oo_fwd_control_em1d
#
if [ "$RESULT" -ne "0" ]; then
    #
...
#
mpirun -np 2 ./ModEM_MPI -j -m ../docs/vti_results/model_VTI_h0_v0.mod -pm ../docs/vti_results/model_VTI_h10_v10.mod -d ../docs/vti_results/Data_Z_1tx_1rx.dat -jm jmhat_mt_vti_oo.dat -cf ../docs/vti_results/oo_fwd_control_em1d
#
if [ "$RESULT" -ne "0" ]; then
    #
...
#
mpirun -np 2 ./ModEM_MPI -j -m ../docs/vti_results/model_VTI_h0_v0.mod -pm ../docs/vti_results/model_VTI_h10_v10.mod -d ../docs/vti_results/Data_Ey_1tx_1rx.dat -jm jmhat_em1d_vti_oo.dat -cf ../docs/vti_results/oo_fwd_control_em1d
#
if [ "$RESULT" -ne "0" ]; then
    #
...
################################################################
#
mpirun -np 2 ./ModEM_MPI -i -m ../docs/vti_results/model_ISO_h0.mod -d pred_mt_iso_oo.dat -ci ../docs/vti_results/oo_inv_control_dcg -cf ../docs/vti_results/oo_fwd_control_em1d -o mt_iso_oo_dcg
#
if [ "$RESULT" -ne "0" ]; then
    #
...
#
mpirun -np 2 ./ModEM_MPI -i -m ../docs/vti_results/model_VTI_h0_v0.mod -d pred_mt_vti_oo.dat -ci ../docs/vti_results/oo_inv_control_dcg -cf ../docs/vti_results/oo_fwd_control_em1d -o mt_vti_oo_dcg
#
if [ "$RESULT" -ne "0" ]; then
    #
...
#
mpirun -np 2 ./ModEM_MPI -i -m ../docs/vti_results/model_ISO_h0.mod -d pred_dip1d_oo.dat -ci ../docs/vti_results/oo_inv_control_dcg -cf ../docs/vti_results/oo_fwd_control_dip1d -o dip1d_oo_dcg
#
if [ "$RESULT" -ne "0" ]; then
    #
...
#
mpirun -np 2 ./ModEM_MPI -i -m ../docs/vti_results/model_ISO_h0.mod -d pred_em1d_iso_oo.dat -ci ../docs/vti_results/oo_inv_control_dcg -cf ../docs/vti_results/oo_fwd_control_em1d -o em1d_iso_oo_dcg
#
if [ "$RESULT" -ne "0" ]; then
    #
...
#
mpirun -np 2 ./ModEM_MPI -i -m ../docs/vti_results/model_VTI_h0_v0.mod -d pred_em1d_vti_oo.dat -ci ../docs/vti_results/oo_inv_control_dcg -cf ../docs/vti_results/oo_fwd_control_em1d -o em1d_vti_oo_dcg
#
if [ "$RESULT" -ne "0" ]; then
    #
