...
LAST=1
#
start_model="../inputs/MR_TEST/CSEM/m0.rho"
real_model="../inputs/MR_TEST/CSEM/m.rho"
data="../inputs/MR_TEST/CSEM/d_05.dat"
#
...
for FWD_CONTROL in $FWD_CONTROLS; do
    ...
    for (( i=$FIRST; i<=$LAST; i++ )); do
        ...
        #
        mpirun -np $procs ./ModEM -jt -m $start_model -d $data -cf $FWD_CONTROL -dm DSIGMA_$OUTPUT.rho | tee -a DSIGMA_$OUTPUT.txt
        #
