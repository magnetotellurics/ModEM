...
#
bash scripts/test_forward.sh bin/Mod3DMT_STD inputs/rFile_userCtrl_MT-QMR 10
#
echo "#" >> outputs/temp/summary.txt
#
echo "test_forward STD QMR MT = update_doxygen.txt" >> outputs/temp/summary.txt
#
bash scripts/test_forward.sh bin/Mod3DMT_STD inputs/rFile_userCtrl_CSEM-QMR 10
#
...
echo "#" >> outputs/temp/summary.txt
#
bash scripts/test_forward.sh bin/Mod3DMT_STD inputs/rFile_userCtrl_MT-BICG 10
#
echo "update_doxygen = update_doxygen.txt" >> outputs/temp/summary.txt
echo "#" >> outputs/temp/summary.txt
#
bash scripts/test_forward.sh bin/Mod3DMT_STD inputs/rFile_userCtrl_CSEM-BICG 10
#
#
...
echo "#" >> outputs/temp/summary.txt
#
bash scripts/test_forward.sh bin/Mod3DMT_SP2 inputs/rFile_userCtrl_MT-BICG 10
#
echo "update_doxygen = update_doxygen.txt" >> outputs/temp/summary.txt
echo "#" >> outputs/temp/summary.txt
#
bash scripts/test_forward.sh bin/Mod3DMT_SP2 inputs/rFile_userCtrl_CSEM-BICG 10
#
#
