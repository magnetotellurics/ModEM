...
module GridCalc
  ...
  interface EdgeVolume
    module procedure EdgeVolumeFD
  end interface

  interface FaceVolume
    module procedure FaceVolumeFD
  end interface

  interface NodeVolume
    module procedure NodeVolumeFD
  end interface

  interface CellVolume
    module procedure CellVolumeFD
  end interface

  interface EdgeLength
    module procedure EdgeLengthFD
  end interface

  interface FaceLength
    module procedure FaceLengthFD
  end interface

  interface EdgeArea
    module procedure EdgeAreaFD
  end interface

  interface FaceArea
    module procedure FaceAreaFD
  end interface
...
Contains
  ...
  subroutine EdgeVolumeFD(grid, V_E, l_E, S_E)
  ...
  end subroutine EdgeVolumeFD  ! EdgeVolume
  ...
  subroutine FaceVolumeFD(grid, V_F, l_F, S_F)
  ...
  end subroutine FaceVolumeFD  ! FaceVolume
  ...
  subroutine NodeVolumeFD(grid, V_N)
  ...
  end subroutine CellVolumeFD  ! CellVolume
  ...
  subroutine EdgeLengthFD(grid,l_E)
  ...
  subroutine FaceLengthFD(grid,l_F)
  ...
  subroutine EdgeAreaFD(grid,S_E)
  ...
  subroutine FaceAreaFD(grid,S_F)
