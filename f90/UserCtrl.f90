...
module UserCtrl
  ...
  type :: userdef_control
    ...
    ! Out-of-core file prefix for storing working E-field solutions
    character(80)       :: prefix
	...
	! Specify the Covariance Type used in 3D
	integer             :: CovType

	! Indicate how much output you want
	integer             :: output_level

    ! Used for storing E-fields in files (works with prefix above)
