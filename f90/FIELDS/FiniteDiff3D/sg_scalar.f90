...
Contains
  ...
  subroutine read_iscalar(fid, E, ftype)
    ...
    subroutine printRScalar( E, io_unit, title )
        implicit none
        !
        ...
        do ix = 1, E%nx
             do iy = 1, E%ny
                  do iz = 1, E%nz
                        if( E%v( ix, iy, iz ) /= 0 ) then
                            write(funit,*) ix,iy,iz, ":[", E%v( ix, iy, iz ), "]"
                        endif
                  enddo
             enddo
        enddo
        !
    end subroutine printRScalar
    !
    !> No subroutine briefing
    subroutine printCScalar( E, io_unit, title )
        implicit none
        !
