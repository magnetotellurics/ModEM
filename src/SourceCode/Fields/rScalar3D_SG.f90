...
module rScalar3D_SG
    ...
    type, extends( Scalar_t ) :: rScalar3D_SG_t
        ...
        contains
            ...
            procedure, public :: length => length_rScalar3D_SG
            ...
            !
            procedure, public :: getReal => getReal_rScalar3D_SG
            !
            !> I/O operations
...
contains
    ...
    !> No subroutine briefing
    !
    function length_rScalar3D_SG( self ) result( field_length )
        implicit none
        !
        ...
        !
    end function length_rScalar3D_SG
    !
    !> No subroutine briefing
    !
    ...
    !> No subroutine briefing
    !
    subroutine getReal_rScalar3D_SG( self, r_field )
        implicit none
        !
        class( rScalar3D_SG_t ), intent( in ) :: self
        ...
        !
        call warning( "getReal_rScalar3D_SG > Getting Real Field from already Real Field" )
        !
    end subroutine getReal_rScalar3D_SG
    !
    !> No subroutine briefing
    !
