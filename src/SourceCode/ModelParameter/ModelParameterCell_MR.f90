...
contains
    ...
    !
    function ModelParameterCell_MR_ctor_one_cond( cell_cond, anisotropic_level, param_type ) result( self )
        implicit none
        !
    ...
    !> No subroutine briefing
    !
    function ModelParameterCell_MR_ctor_all_conds( cell_cond, param_type ) result( self )
        implicit none
        !
