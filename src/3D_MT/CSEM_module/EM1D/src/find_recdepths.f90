...
subroutine find_recdepths_general(bgdat,refl_var)
  ...
  if (bgdat%allcomp_samecoord) then
    ...
    if (bgdat%nExy .gt. 0) then
      call find_recdepths_1comp(bgdat%nExy,bgdat%Exypos,&
              refl_var%irecperzExy,refl_var%nzrecExy,refl_var%zrecExy,refl_var%nrecperzExy)
    ...
    if (bgdat%nHxy .gt. 0) then
      call find_recdepths_1comp(bgdat%nHxy,bgdat%Hxypos,refl_var%irecperzHxy,&
              refl_var%nzrecHxy,refl_var%zrecHxy,refl_var%nrecperzHxy)
