...
# INV
#
mpirun -np 55 --hostfile ../../hostfile_55.txt ./ModEM_MPI -i -m ../../modem_inputs/CSEM_Small_model/Starting_model_Small_v_4_h.rho_h -d ../../modem_inputs/CSEM_Small_model/Data_on_Small_Grid_10%Err.dat -ci inv_control -cf it_mf_control -o it_mf
#
mpirun -np 55 --hostfile ../../hostfile_55.txt ./ModEM_MPI -i -m ../../modem_inputs/CSEM_Small_model/Starting_model_Small_v_4_h.rho_h -d ../../modem_inputs/CSEM_Small_model/Data_on_Small_Grid_10%Err.dat -ci inv_control -cf it_sp_control -o it_sp
#
mpirun -np 55 --hostfile ../../hostfile_55.txt ./ModEM_MPI -i -m ../../modem_inputs/CSEM_Small_model/Starting_model_Small_v_4_h.rho_h -d ../../modem_inputs/CSEM_Small_model/Data_on_Small_Grid_10%Err.dat -ci inv_control -cf dc_mf_control -o dc_mf
#
mpirun -np 55 --hostfile ../../hostfile_55.txt ./ModEM_MPI -i -m ../../modem_inputs/CSEM_Small_model/Starting_model_Small_v_4_h.rho_h -d ../../modem_inputs/CSEM_Small_model/Data_on_Small_Grid_10%Err.dat -ci inv_control -cf dc_sp_control -o dc_sp
#