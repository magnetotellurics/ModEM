module rScalar
    ...
    type, abstract :: rScalar_t
     ...
     contains
		!
        procedure, public :: init => initializeRScalar
        !**
        ! Input/Output
        !*
        ...
        ! Miscellaneous
        !*
        procedure(iface_isCompatible1), deferred, public :: isCompatible1
    ...
    abstract interface
        ...
        function iface_isCompatible1(self, rhs) result(status)
            import :: rScalar_t
            class(rScalar_t), intent(in) :: self
            class(rScalar_t), intent(in) :: rhs
            logical :: status
...
contains
    !
    subroutine initializeRScalar( self )
        implicit none
        !
        class( rScalar_t ), intent( inout ) :: self
        !
        ...
        !
    end subroutine initializeRScalar
    !
end module rScalar
