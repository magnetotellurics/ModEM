...
module Grid2D
   !
   use Constants
   !    just use these character string parameters from abstract class ---
   !      only these are relevant to a 2D grid
   !use Grid, only:    CORNER, CENTER, YEDGE, ZEDGE
   use Grid1D
   private 
   public :: Grid2D_t
   !      maybe this should be an extension of Grid3D_SG_t !
   type :: Grid2D_t
       !**
       ! Grid Dimensions:
       ...
       ! nz = nzAir + nzEarth
       !*
       integer :: ny = 0, nz = 0   ! Number of grid cells in y,z
                                          ! directions
