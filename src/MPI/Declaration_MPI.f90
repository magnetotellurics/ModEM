...
size_of_res_vector=size(worker_job_task%solver_residual_vec)
        ...
        call MPI_Pack(worker_job_task%solver_number_of_iterations, &
                1, MPI_INTEGER, worker_job_package, Nbytes, index, MPI_COMM_WORLD, ierr)
...
size_of_res_vector=size(worker_job_task%solver_residual_vec)
        ...
        call MPI_Unpack(worker_job_package, Nbytes, &
                index, worker_job_task%solver_number_of_iterations,1, MPI_INTEGER,MPI_COMM_WORLD, ierr)
