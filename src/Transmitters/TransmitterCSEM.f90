...
contains
    ...
    subroutine solveTransmitterCSEM( self )
        ...
        if( self%source%calc_sens ) then
            !
            write( *, "( a43, es12.2)" ) "- Solving CSEM e_sens for period=", self%period
            !
            ...
            if( self%i_sol == 0 ) then
                !
                write( *, "( a44, es12.2)" ) "- Solving CSEM e_sol_0 for period=", self%period
                !
                ...
                !
                write( *, "( a44, es12.2)" ) "- Solving CSEM e_sol_1 for period=", self%period
                !
